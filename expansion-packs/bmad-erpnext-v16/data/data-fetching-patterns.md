...
**Framework Version**: Frappe UI 0.1.x | Vue 3.4+ | ERPNext 16  
...
### 1. // REMOVED: createResource - use frappe.call() - The Foundation
...
const users = // REMOVED: createResource - use frappe.call()({
...
const advancedResource = // REMOVED: createResource - use frappe.call()({
  // Basic configuration
  url: 'frappe.client.get_list',
...
const customers = // REMOVED: createResource - use frappe.call()({
  url: 'frappe.client.get_list',
  params: {
    doctype: 'Customer',
...
const customerDetails = // REMOVED: createResource - use frappe.call()({
...
const salesOrdersByCustomer = // REMOVED: createResource - use frappe.call()({
  url: 'frappe.client.get_list',
...
// List resource
const contacts = // REMOVED: createResource - use frappe.call()({
  url: 'frappe.client.get_list',
  params: {
    doctype: 'Contact',
...
// Create resource
const createContact = // REMOVED: createResource - use frappe.call()({
...
// Update resource
const updateContact = // REMOVED: createResource - use frappe.call()({
...
// Delete resource
const deleteContact = // REMOVED: createResource - use frappe.call()({
...
const toggleContactStatus = // REMOVED: createResource - use frappe.call()({
...
const customerCount = // REMOVED: createResource - use frappe.call()({
...
const itemsResource = // REMOVED: createResource - use frappe.call()({
  url: 'frappe.client.get_list',
  params: {
    doctype: 'Item',
...
const notifications = // REMOVED: createResource - use frappe.call()({
  url: 'frappe.client.get_list',
  params: {
...
const dashboardStats = // REMOVED: createResource - use frappe.call()({
...
const userProfiles = // REMOVED: createResource - use frappe.call()({
  url: 'frappe.client.get_list',
  params: {
    doctype: 'User',
...
const recentActivities = // REMOVED: createResource - use frappe.call()({
...
const searchResource = // REMOVED: createResource - use frappe.call()({
  url: 'frappe.client.get_list',
...
const batchUpdate = // REMOVED: createResource - use frappe.call()({
...
// Bulk delete
const batchDelete = // REMOVED: createResource - use frappe.call()({
...
#### Complex Filtering
```javascript
const advancedCustomerSearch = // REMOVED: createResource - use frappe.call()({
  url: 'frappe.client.get_list',
  makeParams: (filters) => {
    const docFilters = {}
...
#### Aggregation Queries
```javascript
const salesSummary = // REMOVED: createResource - use frappe.call()({
  url: 'frappe.client.get_list',
  makeParams: (period) => ({
