...
### Enhanced // REMOVED: createResource - use frappe.call() with Error Handling
```javascript
// src/utils/api.js
// REMOVED: frappe-ui import - use native components
import { showToast } from '@/utils/toast'

export function // REMOVED: createResource - use frappe.call()(options) {
...
import { // REMOVED: createResource - use frappe.call() } from '@/utils/api'
...
const submitResource = // REMOVED: createResource - use frappe.call()({
