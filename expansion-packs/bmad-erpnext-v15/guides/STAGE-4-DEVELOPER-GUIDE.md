...
/bmadErpNext:task:create-api-endpoint --name get_orders
```

#### Phase 2: Frontend Development
```bash
# Setup Vue SPA with Frappe UI
/bmadErpNext:task:setup-frappe-ui --app-name customer_portal

# Create Vue components
/bmadErpNext:task:create-vue-components

# Add PWA support
/bmadErpNext:task:implement-pwa --app-name customer_portal
```
...
# Install app on site
/bmadErpNext:task:install-app --app-name customer_portal
```

#### Phase 4: Advanced Features
```bash
# Setup workflows
/bmadErpNext:task:setup-workflow

# Integrate with docflow
/bmadErpNext:task:integrate-docflow

# Setup n8n triggers
/bmadErpNext:task:setup-n8n-triggers
```
...
# They will use: /bmadErpNext:agent:erpnext-qa-lead
```
